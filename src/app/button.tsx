...
const Button = (props: { url: string; download_name: string; children: string; }) => {
    return (
        <div class="pb-3 flex gap-3 justify-center">
            <Link href={props.url} target="_blank" class="w-[80%]">
            ...
            <Link href={props.url} download={props.download_name} aria-label={`${props.download_name} Download`} class="w-[20%]">
